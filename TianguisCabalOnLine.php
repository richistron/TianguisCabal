...
<?php
  /*
    ...
    CREATE TABLE `Ventas` (
      ...
      `Calidad` enum('Excelente','Muy Buena','Buena','Regular','Partes')
         default 'Muy Buena',
      ...
      CONSTRAINT `Ventas_ibfk_2` FOREIGN KEY (`Categoria`)
        REFERENCES `Categoria` (`Categoria`),
      CONSTRAINT `Ventas_ibfk_1` FOREIGN KEY (`UserID`)
        REFERENCES `Vendedores` (`UserID`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
  */
